...
class FogOfWarControllerTest {
    ...
    private fun createFixture(
        ...
        observePackedExploredTilesFlowFactory: (ExplorationTileRange) -> com.github.arhor.journey.feature.map.fow.PackedExploredTilesFlow =
            { MutableStateFlow(Output.Success(packedExploredTiles)) },
        observeWatchtowerRevealFlowFactory: (GeoBounds, Int) -> com.github.arhor.journey.feature.map.fow.WatchtowerRevealFlow =
